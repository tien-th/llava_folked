...
python llava/train/debug.py \
    ...
    --vision_tower /home/user01/aiotlab/htien/pet-clip/ViT_ckpts/CTVit.39000.pt \
    --pretrain_mm_mlp_adapter /home/user01/aiotlab/thaind/LLaVA/checkpoints/ctvit_projector_llavamed-llava-med-v1.5-mistral-7b-pretrain/checkpoint-1912/mm_projector.bin \
    --mm_vision_select_layer -2 \
    --mm_use_im_start_end False \
    --mm_use_im_patch_token False \
    --bf16 True \
    --output_dir ./checkpoints/ctvit_llavamed-$MODEL_VERSION-finetune_lora_10_epochs \
    --num_train_epochs 10 \
