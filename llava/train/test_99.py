...
top_p = None
model_name = 'llava'
question_file = '/home/user01/aiotlab/thaind/data_desc_conv_val_filtered.json'

def test(lora_adapter_path=None, attn_implementation=None):
    ...
    if model_args.vision_tower is not None:
        ...
        answers_file = '/home/user01/aiotlab/thaind/LLaVA/ans_conv_val_filtered_RotateAug.json'
