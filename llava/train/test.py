...
answers_file = '/home/user01/aiotlab/thaind/llavamed_test_data_answer.jsonl'
temperature = 0.2
num_beams = 1 
top_p = None
model_name = 'llava'
model_path = '/home/user01/aiotlab/thaind/LLaVA/checkpoints/llavamed-llava-med-v1.5-mistral-7b-pretrain-20epochs'
question_file = '/home/user01/aiotlab/thaind/llavamed_test_data.json'
    ...
    if model_args.vision_tower is not None:
        ...
        for line in tqdm(questions):
            ...
            ans_file.write(json.dumps({
                "question_id": idx,
                "prompt": cur_prompt,
                "text": outputs,  # Chuỗi tiếng Việt sẽ được giữ nguyên
                "model_id": model_name,
                "metadata": {}
            }, ensure_ascii=False) + "\n")
