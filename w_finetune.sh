...
#SBATCH --output=w_result_thaind_llavamed_finetune.txt      # Output file
#SBATCH --error=w_error_thaind_llavamed_finetune.txt        # Error file
...
sh scripts/finetune_lora_pet.sh